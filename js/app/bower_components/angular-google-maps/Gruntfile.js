...
(function() {
  ...
  module.exports = function(grunt) {
    ...
    grunt.registerTask('build', ['bowerCurl', 'clean:dist', 'jshint', 'mkdir', 'coffee', 'ngAnnotate', 'concat:libs', 'replace', 'webpack']);
